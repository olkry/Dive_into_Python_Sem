...
class Rectangle:
    ...
    def __init__(self, width, height=None):
        ...
        if height is None:
            ...
            self.height = height
        if width < 0 and (height is not None and height < 0):
    ...
    @width.setter
    def width(self, n_wigth):
        if n_wigth < 0:
            raise NegativeValueError(f'Ширина должна быть положительной, а не {n_wigth}')
    ...
    def height(self, n_height):
        if n_height < 0:
            raise NegativeValueError(f"Высота должна быть положительной, а не {n_height}")
